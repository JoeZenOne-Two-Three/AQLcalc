function calculate() {
  ...
  const plans = {
    "0.1": [
      ...
      { max: 280, size: 32, ac: 0, re: 1 },
      { max: 500, size: 50, ac: 0, re: 1 },
      { max: 1200, size: 80, ac: 0, re: 1 },
      { max: 3200, size: 125, ac: 0, re: 1 },
      { max: 10000, size: 200, ac: 1, re: 2 },
      { max: Infinity, size: 315, ac: 1, re: 2 },
    ],
    "0.4": [
      { max: 25, size: 5, ac: 0, re: 1 },
      { max: 50, size: 8, ac: 0, re: 1 },
      ...
      { max: Infinity, size: 315, ac: 7, re: 8 },
    ],
    "0.65": [
    ...
    "1.0": [
      ...
      { max: Infinity, size: 500, ac: 21, re: 22 },
    ],
    "2.5": [
